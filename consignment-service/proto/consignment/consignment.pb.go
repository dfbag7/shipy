...
func init() {
	proto.RegisterType((*Consignment)(nil), "consignments.Consignment")
	proto.RegisterType((*Container)(nil), "consignments.Container")
	proto.RegisterType((*GetRequest)(nil), "consignments.GetRequest")
	proto.RegisterType((*Response)(nil), "consignments.Response")
}
...
var fileDescriptor_e5e5ab05dfa973d5 = []byte{
	...
	,
}
...
func (c *shippingServiceClient) CreateConsignment(ctx context.Context, in *Consignment, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/consignments.ShippingService/CreateConsignment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) GetConsignments(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/consignments.ShippingService/GetConsignments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ShippingService_CreateConsignment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/consignments.ShippingService/CreateConsignment",
	}
...
func _ShippingService_GetConsignments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/consignments.ShippingService/GetConsignments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ShippingService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "consignments.ShippingService",
